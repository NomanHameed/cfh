                    ...
                    <div class="card card-body bg-primary text-white">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-fill text-end">
                                <h4 class="mb-0">
                                    {{ number_format($customer->details()->where('type','Recieved')->sum('amount') )}}
                                </h4>
                                Total Recieved
                            </div>
                        </div>
                ...
                <div class="col-sm-6 col-xl-4">
                    <div class="card card-body bg-success text-white">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-fill text-end">
                                <h4 class="mb-0">
                                    {{ number_format($customer->details()->where('type','Recieved')->sum('amount') - $customer->details()->where('type','Paid')->sum('amount') )}}
                                </h4>
                                Current Balance
                            </div>
                        </div>
