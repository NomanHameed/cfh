...
<div class="col-md-12">
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">{{ __('Create') }} Production Payment</h5>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ route('production-payments.store') }}" class="validate" role="form" enctype="multipart/form-data">
                @csrf
