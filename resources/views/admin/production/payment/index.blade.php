...
<div class="page-header-content d-lg-flex">
    ...
    @can('production-payments-create')
...
<div class="col-sm-12">
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">Production Payment</h5>
        </div>
            ...
            @foreach ($productionPayments as $key => $productionPayment)
                <tr>
                    <td>{{ ++$key }}</td>
											...
											<td>{{ $productionPayment->worker_id }}</td>
											<td>{{ $productionPayment->date }}</td>
											<td>{{ $productionPayment->amount }}</td>
...
@endsection
@canany(['production-payments-view', 'production-payments-edit', 'production-payments-delete'])
