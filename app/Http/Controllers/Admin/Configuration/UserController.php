...
use App\Http\Controllers\Configuration\Hash;
...
class UserController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.configuration.users.create',compact('roles','user'));
    }
    ...
    {
        $user = User::find($id);
        return view('admin.configuration.users.show', compact('user'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.configuration.users.edit',compact('user','roles','userRole'));
    }
