...
class TransactionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.banking.transaction.index', compact('transactions'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.banking.transaction.create', compact('transaction'));
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.banking.transaction.show', compact('transaction'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.banking.transaction.edit', compact('transaction'));
    }
